...
PHASE_KEYWORDS = {
    'gas': ['CH4', 'CO2', 'N2O', 'VOCs', 'H2S', 'O2', '甲烷', '氧化亚氮',
            'emission_factor', '排放因子', '温室气体', 'GHG', 'carbon'],
    ...
    'env': ['气温', '泥水', '采样时间', '采样时段', '井深', '管径', '本底',
            '处理规模', '规模等级', '研究区域', '方法学', '核算方法',
            'WWTP', '污水处理', '工艺', 'treatment', 'process'],
}
...
SHORT_NAMES = {
    ...
    # WWTPs 元分析变量
    'CH4': 'CH₄', 'N2O': 'N₂O',
    '排放因子法': 'EF', '实测法': 'DM', '模型法': 'Model',
    '核算方法': 'Method', '处理规模': 'Scale', '规模等级': 'Level',
    '研究区域': 'Region', '方法学': 'Methodology',
}
